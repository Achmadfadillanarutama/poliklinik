            ...
            <tbody>
                ...
                if ($result) {
                    ...
                    while ($data = mysqli_fetch_array($result)) {
                        ...
                        echo "<td>";
                        echo "<a class='btn btn-success rounded-pill px-3' href='pasien.php?id=" . $data['id'] . "'>Ubah</a> ";
                        echo "<a class='btn btn-danger rounded-pill px-3' href='pasien.php?id=" . $data['id'] . "&aksi=hapus' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'>Hapus</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                } else {
